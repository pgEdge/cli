...
def write_config():
    """
    Write the current pgBackRest BACKUP settings to a YAML file named <stanza>.yaml
    in the ./backrest directory.
    """
...
def update_config(verbose=True):
    """
    Read the pgBackrest YAML generated by write_config and
