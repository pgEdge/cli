...
add_data = util_test.write_psql("INSERT INTO foo (empid, empname) VALUES(7,'Gertrude'), (8, 'Howard'), (9, 'Iris'), (10, 'Jack'), (11, 'Kathy'), (12, 'Lola');",host,dbname,port,pw,usr)
print("*"*100)
...
if "Adding" not in str(repset_add.stdout) or repset_add.returncode != 0:
    util_test.EXIT_FAIL
else:
    util_test.EXIT_PASS
