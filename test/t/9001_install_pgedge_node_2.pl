...
my $cmd2 = qq(curl -fsSL https://pgedge-upstream.s3.amazonaws.com/REPO/install24.py > $n2/install.py);
print("cmd2 = $cmd2\n");
my ($success2, $error_message2, $full_buf2, $stdout_buf2, $stderr_buf2)= IPC::Cmd::run(command => $cmd2, verbose => 0);

# Move into the pgedge directory and run the install.py file.

chdir("./pgedge/cluster/demo/n2/");

print("We just moved into $n2");

my $cmd3 = qq(python $n2/install.py);
print("cmd3 = $cmd3\n");
...
my $cmd4 = qq($n2/pgedge/nodectl install pgedge -U $username -P $password -d $database -p 6433 $inst_version);
print("cmd4 = $cmd4\n");
...
my $json2 = `$n2/pgedge/nc --json info pg17`;
