...
#
# Confirm that db guc-set throws an ERROR if the user tries to set a GUC to an invalid type.
# 
command = "db guc-set client_min_messages 7"
res=util_test.run_cmd("Setting client_min_messages to 7.", command, f"{cluster_dir}/n1")
print(res)
print("*"*100)
#
# Needle and Haystack
