...
#
# In this case, we'll check node 1 and check the repset on that node.
...
# check node 1 and the repset entry on n1: 

my $cmd2 = qq($homedir/nodectl spock node-list $database);
print("cmd2 = $cmd2\n");
