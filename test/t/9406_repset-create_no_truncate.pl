...
my $cmd3 = qq($homedir1/nodectl spock repset-create --replicate_truncate=False $repset $database);
print("cmd3 = $cmd3\n");
...
my $cmd5 = qq($homedir2/nodectl spock repset-create --replicate_truncate=False $repset $database);
print("cmd5 = $cmd5\n");
