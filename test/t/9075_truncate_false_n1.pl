...
#
# In this case, we will create the --repset_truncate=False on node1.
#created table
...
#Creating repset (demo-notruncate-repset) 
#
## 
my $cmd3 = qq($homedir/nodectl spock repset-create --replicate_truncate=False $repset $database);
print("cmd3 = $cmd3\n");
...
print("We just executed the command that creates the replication set (demo-notruncate-repset)\n");
...
print ("-"x150,"\n");
 ...
 print("\n");
   ...
   #Adding Table to the Repset
    ...
    my $cmd8 = qq($homedir/nodectl spock repset-add-table $repset public.foo_no_truncate $database);
    print("cmd8 = $cmd8\n");
...
if(contains(@$stdout_buf5[0], "demo-notruncate-repset"))
