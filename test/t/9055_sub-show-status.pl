...
# Confirm that spock sub-show-status errors-out gracefully if the subscription name is missing:

my $cmd10 = qq($homedir2/nodectl spock sub-show-status lcdb);
print("cmd10 = $cmd10\n");
...
my $cmd11 = qq($homedir2/nodectl spock sub-show-status sub_n2n1);
print("cmd11 = $cmd11\n");
...
# Confirm that spock sub-show-status errors-out gracefully if both parameters are missing:

my $cmd12 = qq($homedir2/nodectl spock sub-show-status);
print("cmd12 = $cmd12\n");
...
my $cmd13 = qq($homedir2/nodectl spock sub-show-status sub_n2n1 lcdb);
print("cmd13 = $cmd13\n");
...
if(contains(@$stdout_buf13[0], "sub_n2n1"))
