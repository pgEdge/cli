...
my $cmd25 = qq($homedir/nodectl spock sub-add-repset sub_n2n3 $repset $database);
print("cmd25 = $cmd25\n");
...
# Use psql to query the spock.replication_set_table table to confirm that the repset is added:

print("We just added the repsets to the subscriptions on ($n2).\n");
