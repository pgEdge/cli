...
#
# In this case, we will create the --repset_update=False on node1.
...
#Creating repset (demo-noupdate-repset) 
#
## 
my $cmd3 = qq($homedir/nodectl spock repset-create --replicate_update=False $repset $database);
print("cmd3 = $cmd3\n");
...
print("We just executed the command that creates the replication set (demo-noupdate-repset)\n");
