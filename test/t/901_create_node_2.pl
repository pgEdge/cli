...
my $cmd2 = qq(curl -fsSL https://pgedge-upstream.s3.amazonaws.com/REPO/install.py > $n2/install.py);
print("cmd2 = $cmd2\n");
...
my $cmd4 = qq($n2/pgedge/nodectl install pgedge -U $username -P $password -d $database -p 6433);
print("cmd4 = $cmd4\n");
