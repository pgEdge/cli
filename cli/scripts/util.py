...
def update_postgresql_conf(p_pgver, p_port, is_new=True,update_listen_addr=True):
  ...
  for line in lines:
    ...
    elif pkg_mgr == "apt" and (line.startswith("#dynamic_shared_memory_type") or 
...
def get_el_ver():
  if platform.system() == "Darwin":
    message("# WARNING! OSX is only used for client functionality such as CLUSTER & ACE commands.")
   return "osx"
