...
class TestTableRepairFixNulls:
    ...
    def test_simple_nulls(self, cli, capsys):
        ...
        cli.table_repair_cli(
            "eqn-t9da", diff_file_path, "n1", "public.simple_nulls", fix_nulls=True
        )
    ...
    def test_composite_nulls(self, cli, capsys):
        ...
        # Run table-repair with fix-nulls
        cli.table_repair_cli(
            "eqn-t9da", diff_file_path, "n3", "public.composite_nulls", fix_nulls=True
        )
    ...
    def test_mixed_case_nulls(self, cli, capsys):
        ...
        # Run table-repair with fix-nulls
        cli.table_repair_cli(
            "eqn-t9da", diff_file_path, "n1", "public.MixedCaseNulls", fix_nulls=True
        )
    ...
    def test_datatype_nulls(self, cli, capsys):
        ...
        # Run table-repair with fix-nulls
        cli.table_repair_cli(
            "eqn-t9da", diff_file_path, "n1", "public.datatype_nulls", fix_nulls=True
        )
