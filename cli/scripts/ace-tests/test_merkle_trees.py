...
class TestMerkleTrees:
    ...
    @pytest.mark.parametrize(
        "table", ["public.customers", "public.customers1", "public.customers2"]
    )
    def test_merkle_tree_setup(self, cli, capsys, table, nodes):
        ...
        cli.merkle_tree_cli("build", "eqn-t9da", table)
    ...
    def test_mtree_table_cleanup(self, cli, capsys, table, nodes):
        cli.merkle_tree_cli("teardown", "eqn-t9da", table)
        ...
        cli.merkle_tree_cli("teardown", "eqn-t9da", "customers1")
        ...
        cli.merkle_tree_cli("teardown", "eqn-t9da", "customers2")
    ...
    @pytest.mark.skip(reason="Skipping block boundary tests")
    @pytest.mark.usefixtures("setup_test_scenario")
    @pytest.mark.parametrize(
