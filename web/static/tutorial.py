...
Get into the <code>pgedge</code> base directory at the command line.
<p>Now run the <code>help</code> command to see that things are as expected
<pre>

   <font size=+1>$ ./nc help</font>

      <b>Usage:</b> nc command [component1 component2 ...]

      <b>Available commands:</b>
        <b>help</b>       - Show this help file
        <b>info</b>       - Display OS or component informatncn
        ...
        <b>upgrade</b>    - Upgrade installed components to newer (compatible) versncns
...
<br>
<h4>2.) Demonstrate the <code>nc</code> command line environment.</h4>

The <code>info</code> command lists informatncn about the OS or a component
<pre>
   <font size=+1>$ ./nc info</font>
...
<pre>
   <font size=+1>$ ./nc list</font>

        <b>Component     Versncn       Port    Status      
        ------------  ------------  ------  ------------</b>
...
<pre>     
   <font size=+1>$ ./nc start</font>

       pg14 starting...
</pre>

<br>
Running the <code>status</code> command displays informatncn about installed server components.
<pre>     
   <font size=+1>$ ./nc status</font>
...
<pre>     
   <font size=+1>$ ./nc stop</font>

       pg14 stopping...
</pre>

<br>
<h4>3.) Install additncnal components</h4>

Use the <code>install</code> command to provisncn additncnal components such as <code>pg12</code>.
Using the "--start" optncn will install and then start PG with the default passwd = 'password'.  Because port 5432
was in use, we automagically start on port 5433.
<pre>
   <font size=+1>$ ./nc install pg12 --start</font>
...
<pre>
   <font size=+1>$ ./nc start pg14</font>
